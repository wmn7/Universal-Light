...
###
 ...
 # @Command: nohup bash train_without_ad.sh > train_without_ad.log &
...
do
    python ${FOLDER}/train_singleEnv.py --net_name=$net_name --stack=6 --cpus=$CPU --delay=0 --model_name=ernn
    echo '完成, ' $net_name
done