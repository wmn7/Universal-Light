...
from SumoNets.TEST_CONFIG import TEST_SUMO_CONFIG as SUMO_CONFIG
...
def sim_fix_time(net_name:str, fix_time:int):
    ...
    routes_name = SUMO_CONFIG[FOLDER_NAME]['routes'] # route file (包含多个路网文件)
...
if __name__ == '__main__':
    test_nets = ['test_four_34', 'test_three_34', 'cologne1', 'ingolstadt1']
