...
@Description: 测试 Fix Time 策略的结果
@LastEditTime: 2023-03-01 17:39:04
'''
...
if __name__ == '__main__':
    ...
    output_folder = pathConvert(f'./Result/FixTime/{FOLDER_NAME}/{_net}/{_route}/')
